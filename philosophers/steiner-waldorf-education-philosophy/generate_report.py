#!/usr/bin/env python3
"""Generate markdown report from Steiner-Waldorf education philosophy research JSON results."""
...
CATEGORY_MAPPING = {
    ...
    "Anthroposophical Foundation": ["anthroposophical_foundation", "Anthroposophical Foundation", "anthroposophicalFoundation"],
