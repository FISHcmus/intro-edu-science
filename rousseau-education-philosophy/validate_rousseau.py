...
CATEGORY_MAPPING = {
    ...
    "philosophical_foundation": ["philosophical_foundation", "Philosophical Foundation"],
    "educational_principles": ["educational_principles", "Educational Principles"],
    "developmental_theory": ["developmental_theory", "Developmental Theory"],
    "historical_context": ["historical_context", "Historical Context"],
    "influence_and_legacy": ["influence_and_legacy", "Influence & Legacy"],
    "critiques_and_controversies": ["critiques_and_controversies", "Critiques & Controversies"],
    "comparative_analysis": ["comparative_analysis", "Comparative Analysis"],
    "key_quotes": ["key_quotes", "Key Quotes"],
    "vietnamese_relevance": ["vietnamese_relevance", "Vietnamese Relevance"],
}
...
def load_fields_yaml(fields_path):
    ...
    for category in data.get("categories", {}).values():
        for field in category.get("fields", []):
            items.append((field["name"], category.get("display_name", "Unknown"), field.get("required", False)))
